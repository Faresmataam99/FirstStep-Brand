      ...
      <div className="flex justify-between items-center p-10 w-full max-w-screen-lg">
        ...
        <div>
          <ul className=" flex flex-row gap-6 font-semibold text-lg">
            ...
            <li className="hover:underline">
              <Link href="/shopping">Clothing</Link>
            </li>
            <Link href={"/shopping"}><li className="hover:underline">
Accessories
            </li></Link>
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="flex justify-start w-full p-8">
         <Link href={"/shopping"}> <h1 className="text-2xl">Explore Sport</h1></Link>
        </div>
        <div className="grid grid-cols-2 w-full items-center justify-center">
          {/* First Grid Item */}
         <Link href={"/shopping"}><div className="relative bg-cover bg-center h-80  ">
          ...
          {/* Second Grid Item */}
        <Link href={"/shopping"}>  <div className="h-80 relative bg-cover bg-center ">
