...
<div className="flex items-center jusitfy-center max-w-screen-xl m-auto flex-col ">
        <div className="bg-white w-full justify-between text-lg font-semibold flex p-4">
            <p>Men</p>
...
<div>
    <img src="https://i.pinimg.com/736x/00/0a/c5/000ac51668dd3830f49c7290b96d1506.jpg" alt="" className="w-screen"  />
...
<p className="text-xl font-semibold p-3">Trending</p>
{/* gris section */}
...
<div className="absolute inset-0 flex flex-col gap-3 justify-end bg-opacity-30 p-4 text-white ">
